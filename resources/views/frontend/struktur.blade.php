<section id="struktur" class="py-12 sm:py-16 bg-slate-50/70 border-b border-slate-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8" data-aos="fade-up">
            ...
            <a href="{{ route('organisasi.index') }}" class="group inline-flex items-center gap-2 text-xs font-bold text-emerald-700 bg-white hover:bg-emerald-600 hover:text-white px-4 py-2.5 rounded-xl transition-all duration-300 shadow-sm hover:shadow-md border border-slate-200/80 self-start sm:self-auto flex-shrink-0">
